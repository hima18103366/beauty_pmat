...
<h2>Doctor Appointment Report</h2>
...
@if ($errors->any())
  ...
  @endforeach
  @endif
<form action="{{route('dappointment_report_search')}}" method="get">
...
<button onclick="printDiv('dappointment_report')" class="btn btn-danger">Print</button>
