...
<body>
  <div class="container mt-4">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Appointment Link Confirmation</h4>
        <p>Dear Customer,</p>
        ...
        <p>your Link: {{$link}}</p><br><br>

        <p>your patient_name: {{$patient_name}}</p>
        <p>your patient_age: {{$patient_age}}</p>
        <p>your medications: {{$medications}}</p>
        <p>your notes: {{$notes}}</p><br><br>
